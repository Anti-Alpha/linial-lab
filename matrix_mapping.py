...
def affine_transform(
    ...
    Args:
        ...
        scale (tuple[float, float]): x, y scale factors.
        shear (tuple[float, float]): x, y shear factors.
        translate (tuple[float, float]): x, y translation factors.
    ...
    transformed_x = (transform_matrix @ x.T).T + translate
